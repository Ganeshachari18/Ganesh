        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2>Update Employee Details<br> </h2>
            </div>
          </div>
        </div>
      </div> </section><br><br>
...
<section id="content">
      <div class="container">
        <div class="row">
          <div class="span12">
 <form action="updatedata.jsp" method="post" role="form" class="contactForm">
              ...
              <div class="span4 form-group">
               ...
               <div class="span4 form-group">
                ...
                <div class="span4 form-group">
                  <input type="email" name="email" class="form-control" value=<%= email %> required id="email" placeholder="Enter Email" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <div class="validation"></div>
                </div><br><br><br>              
                 <div class="span4 form-group">
