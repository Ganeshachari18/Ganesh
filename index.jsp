          ...
          <div class="row" >
            <div class="span12" >
              ...
              <div class="nivo-caption" id="caption-3">
                <div>
                  <h2>User  <strong>Friendly</strong></h2>
                  <p>
                ...
                <div>
                  <h2>Online Task <strong>Allocation</strong></h2>
                  <p>
                    Lorem ipsum dolor sit amet nsectetuer nec Vivamus. Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget. Lorem ipsum dolor sit amet nsectetuer nec vivamus.
                  </p>
                  <a href="#" class="btn btn-theme">Read More</a>
              ...
              <div class="nivo-caption" id="caption-2">
                <div>
                  <h2>Fully <strong>Automative</strong></h2>
                  <p>
                    Lorem ipsum dolor sit amet nsectetuer nec Vivamus. Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget. Lorem ipsum dolor sit amet nsectetuer nec vivamus.
                  </p>
                  <a href="#" class="btn btn-theme">Read More</a>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h3>We've solved more than <span class="highlight"><strong>5000 problems</strong></span> last year!</h3>
              </div>
              <div class="cta floatright">
                <a class="btn btn-large btn-theme btn-rounded" href="#">Raise a Problem</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <div class="solidline">
			<h1>Feel Free to Post a Problem</h1>
            </div>
          </div>
        </div>
        <!-- end divider -->
        ...
        <div class="row">
          <div class="span12">
            <h4>Very satisfied <strong>Users</strong></h4>
