...
try{
	...
	ResultSet rs=st.executeQuery("select * from addtask where email='"+email+"' and fromdate='"+ strDate +"'");
	...
	while(rs.next()){
		...
		out.println("<td><a href='taskupdate.jsp?id="+rs.getString(1)+"'>Update</a></td>");
